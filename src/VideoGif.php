<?php
// modified on https://github.com/antalaron/video-gif

namespace MrMohebi\PHPPreviewCreator;

use Intervention\Image\ImageManagerStatic as Image;
use MrMohebi\PHPPreviewCreator\Exception\VideoException;
...
class VideoGif
{
     ...
     *
     * @throws VideoException|\Exception If error during procession or writing.
     */
    public function create($videoFile, $thumbnailFile, $count = null, $interval = null, $width = null, $height = null, $start = null, $end = null)
    {
        ...
        for ($i = 0; $i < $count; ++$i) {
            ...
            Image::make(sprintf($hashDir.'/tmp-frame%03d.jpg', $i))
                ->resize(150, null, function ($const) {
                    $const->aspectRatio();
                })
